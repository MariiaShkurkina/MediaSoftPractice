...
public class DataInitializer {
    ...
    public void init() {
        ...
        // Создаём рестораны
        Restaurant r1 = new Restaurant(null,"Bella Italia", "Итальянская кухня", KitchenType.ITALIAN, 700, BigDecimal.ZERO);
        Restaurant r2 = new Restaurant(null,"Golden Dragon", "Китайская кухня", KitchenType.ASIAN, 500, BigDecimal.ZERO);
        ...
        System.out.println("Средний рейтинг " + r1.getTitle() + ": " + r1.getRating());
        System.out.println("Средний рейтинг " + r2.getTitle() + ": " + r2.getRating());
    }
}
